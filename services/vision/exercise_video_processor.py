...
class VideoProcessor(VideoProcessorBase):
    def __init__(self):
        ...
        self._detectors = {
            ...
            'Biceps Curls (Dumbell)': BicepCurlDetector(),
    ...
    def _draw_overlays(self, img, metrics, ex_type):
        ...
        elif ex_type == 'Biceps Curls (Dumbell)':
            self._draw_bicep_overlays(img, metrics)
        elif ex_type == 'Shoulder Press':
            self._draw_shoulder_overlays(img, metrics)
        elif ex_type == 'Lunges':
    ...
    def _draw_bicep_overlays(self, img, metrics):
        h, _ = img.shape[:2]
    ...
    def _draw_shoulder_overlays(self, img, metrics):
        h, _ = img.shape[:2]
